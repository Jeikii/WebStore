...
export const cartSlice = createSlice({
  ...
  reducers: {
    ...
    removeFromCart: (state, action) => {
      ...
      state.produtsNumber = state.productsNumber - productToRemove.quantity
    ...
    incrementInCart: (state, action) => {
      const itemInc = state.products.find((product) => product.id === action.payload)
    ...
    decrementInCart: (state, action) => {
      const itemDec = state.products.find((product) => product.id === action.payload)
